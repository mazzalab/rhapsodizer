...
def main(r1: str, r2: str, r2_map: str, bed: str, read_length: int, stags_file_name: str, index_file_name: str, matrix_name: str):
    ...
    r1_passed: dict = {}
    # edit file name
    with open('../files/r1_session_cov1.txt', 'r') as r1f:
        for line in r1f:
            line1 = line.split("'")
            r1_passed[line.split(' (')[0]] = (line1[1], line1[3], line1[5], line1[7])
    ...
    r2_map_passed: dict = {}
    # edit file name
    with open('../files/mapping_session_cov1.txt', 'r') as mapf:
        for line in mapf:
            line1 = line.split()
            r2_map_passed[line1[0]] = (line1[1])
